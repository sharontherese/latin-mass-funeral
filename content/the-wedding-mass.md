...
[_Rubrical note: For clarification on when to use the Gradual, the Tract, and the Alleluias, please consult the Rubrics page. Briefly, the Gradual + Tract is used between Septuagesima and Easter; the greater Alleluia (no Gradual or Tract) is used during Easter; most other times will use the Gradual + lesser Alleluia._] 
