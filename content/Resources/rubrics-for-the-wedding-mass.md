...
An incomplete list of some wedding Mass rubrics: 

There is no Gloria or Creed. 

The wedding Mass is a second class votive Mass. On first class feasts, the readings for the first class feast are said.

The bride is always on the left, and the groom on the right (facing the altar). 

The bride and groom receive Communion first.
